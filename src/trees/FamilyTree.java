...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		int colonIndex = index; //should be the index of the colon in line.
		if (colonIndex < 0)
			throw new TreeException("Index cannot be less than 0");
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("Name 1 is null");
		TreeNode node2 = root.getNodeWithName(name2);	// node whose name is name2
		if (node2 == null)
			throw new TreeException("Name 2 is null");
